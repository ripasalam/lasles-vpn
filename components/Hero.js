    ...
    return (
        <section id='about'>
            <div className='mt-20 max-w-screen-xl px-8 lg:px-16 py-3 sm:py-4 mx-auto'>
                <ScrolledAnimation>
                    <motion.div variants={scrollAnimation} className='grid  grid-cols-1 lg:grid-cols-2  py-6 sm:py-16 gap-4 ' >
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 rounded-xl bg-white shadow-md py-9 sm:divide-x-2 divide-dark-300' >
                    <ScrolledAnimation>
